...
<head>
  ...
  <title>Pixelbreeze - Image Templates</title>
            ...
            <div class="flex justify-between items-center h-full">
              <div class="flex items-center md:space-x-4 space-x-2 xl:space-x-0 rtl:space-x-reverse vertical-box">
                <a href="{{ route('admin.home') }}" class="mobile-logo xl:hidden inline-block">
                  <img src="{{ asset('assets/images/logo/logo-c.svg') }}" class="black_logo" alt="logo" style="height: 2vh; width: auto;">
...
{{-- 
      ...
      overflow-hidden">
                    <ul class="py-1 text-sm text-slate-800 dark:text-slate-200">
                      <li>
                        <a href="{{ route('admin.home') }}" class="block px-4 py-2 hover:bg-slate-100 dark:hover:bg-slate-600 dark:hover:text-white font-inter text-sm text-slate-600
            ...
            dark:text-white font-normal">
                      ...
                      <li>
                        <a href="{{ route('admin.image.templates') }}" class="block px-4 py-2 hover:bg-slate-100 dark:hover:bg-slate-600 dark:hover:text-white font-inter text-sm text-slate-600
            dark:text-white font-normal">
          ...
          <div class="page-content">
            <div class="transition-all duration-150 container-fluid" id="page_layout">
              <div id="content_layout">
                    ...
                    @if (in_array($templateId, $user_templates) && $row['name'] != 'Reforma Web News Story 2')
											...
											<div class="col-xl-3 col-md-6 col-lg-6 zoom_up">
												...
												<div project_id="814" class="single_prising finished_task card_shadow">
													...
													<div class="task_footer_cont">
														<a class="task_action_btn" href="{{ route('admin.template', ['p_id' => $templateId]) }}">Create Image</a>
													</div>
												</div>
                      </div>
                    @endif
    ...
    backdrop-filter backdrop-blur-[40px] fixed left-0 bottom-0 w-full z-[9999] bothrefm-0 py-[12px] px-4 md:hidden">
        ...
        <a href="{{ route('admin.home') }}" class="relative bg-white bg-no-repeat backdrop-filter backdrop-blur-[40px] rounded-full footer-bg dark:bg-slate-700
