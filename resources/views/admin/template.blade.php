...
<head>
    ...
    <title>Pixelbreeze - Dashboard</title>
    ...
    <style>
            ...
            /* Add this to your CSS or Bootstrap theme */
            #loadingSpinner {
                position: fixed;
                top: 50%;
                left: 50%;
...
<body class=" font-inter dashcode-app" id="body_class">
      ...
      opacity-0">
            ...
            <div class="sidebar-menus bg-white dark:bg-slate-800 py-2 px-4 h-[calc(100%-80px)] overflow-y-auto z-50"
                ...
                <ul class="sidebar-menu">
                    ...
                    <li class="">
                        <a href="{{ route('admin.image.templates') }}" class="navItem">
                            <span class="flex items-center">
                    ...
                    <div
                        ...
                        <div class="flex justify-between items-center h-full">
                            <div
                                ...
                                <a href="{{ route('admin.home') }}" class="mobile-logo xl:hidden inline-block">
      ...
      overflow-hidden">
            ...
            dark:text-white font-normal">
                          ...
                          <span class="font-Inter">Chat</span>
                                            ...
                                            <li>
                                                <a href="{{ route('admin.image.templates') }}"
                                                    class="block px-4 py-2 hover:bg-slate-100 dark:hover:bg-slate-600 dark:hover:text-white font-inter text-sm text-slate-600
            dark:text-white font-normal">
                                                    <iconify-icon icon="heroicons-outline:mail"
                                                        class="relative top-[2px] text-lg ltr:mr-1 rtl:ml-1"></iconify-icon>
                                                    <span class="font-Inter">Image Templates</span>
                                                </a>
                                            </li>
                                            <li>
                                                <a href="#"
            ...
            dark:text-white font-normal">
                                                    <iconify-icon icon="heroicons-outline:clipboard-check"
                                                        class="relative top-[2px] text-lg ltr:mr-1 rtl:ml-1"></iconify-icon>
                                                    <span class="font-Inter">Video Templates</span>
                                                </a>
                                            </li>
                                            <li>
                                                <a href="#"
                                    ...
                                    <div class="card">
                                        <div class="card-body flex flex-col p-6">
                                            <div class="card-text h-full">
                                                <h6
                                                    class="block text-base text-center font-medium tracking-[0.01em] dark:text-slate-300 text-slate-500 uppercase mb-6">
                                                    PREVIEW</h6>
                                                <div class="flex justify-center">
                                                    <img src="{{ asset('images/' . $templateData['image']) }}"
                                                        class="rounded-md" alt="image" id="NewImgSet">
                                                </div>
                                            </div>
                                            <br />
                                            <div class="inline-flex justify-center">
                                                <a class="btn btn-outline-primary" id="NewImgDownload"
                                                    href=" {{ asset('images/' . $templateData['image']) }}"
                                                    download>Download</a>
                                            </div>
                                        </div>
                                    </div>
    ...
    document.getElementById('NewImgDownload').addEventListener('click', function() {
      ...
      var imgSrc = document.getElementById('NewImgSet').src;
      ...
      // Specify the download attribute and set a desired filename
    ...
    function checkSuggestion(suggest_btn)
    {
        var suggest_btn = suggest_btn;
        var parentDiv = suggest_btn.parentElement;
        ...
        axios.post('/admin/template/text/suggestion', formData)
        .then(function(response) {
            console.log(response);
            suggestion_alert.innerText = response.data.suggestion;
            parentDiv.querySelector(".suggestion").style.display = "block";
            // alert("success!");
        })
    ...
    function checkSuggestion2(suggest_btn)
    {
        var suggest_btn = suggest_btn;
        var parentDiv = suggest_btn.parentElement;
        var text_input = parentDiv.querySelector(".text-suggest");
        ...
        axios.post('/admin/template/text/suggestion-v2', formData)
        .then(function(response) {
            console.log(response);
            suggestion_alert.innerText = response.data.suggestion;
            parentDiv.querySelector(".suggestion").style.display = "block";
