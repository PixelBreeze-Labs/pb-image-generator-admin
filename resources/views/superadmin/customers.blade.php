        ...
        <div class="sidebar-wrapper group">
            ...
            <div class="logo-segment">
                <a class="flex items-center" href="{{ route('superadmin.home') }}">
                    ...
                    {{-- <span
                        class="ltr:ml-3 rtl:mr-3 text-xl font-Inter font-bold text-slate-900 dark:text-white">PixelBreeze</span> --}}
                </a>
                <!-- Sidebar Type Button -->
                                ...
                                <div class=" space-y-5">
                                    ...
                                    <div class="card">
                                        <header class=" card-header noborder">
                                            <h4 class="card-title">Customers Table
                                            </h4>
                                        </header>
                                        <div class="card-body px-6 pb-6">
                                            <div class="overflow-x-auto -mx-6 dashcode-data-table">
                                                ...
                                                <div class="inline-block min-w-full align-middle">
                                                  <button class="btn mx-2 justify-center btn-primary rounded-[25px]">
                                                    <a href="{{ route('superadmin.costumer-create') }}">
                                                      <span class="flex items-center">
                                                    ...
                                                    <div class="overflow-hidden ">
                                                        <table class="min-w-full divide-y divide-slate-100 table-fixed dark:divide-slate-700 data-table">
                                                            ...
                                                            <tbody class="bg-white divide-y divide-slate-100 dark:bg-slate-800 dark:divide-slate-700">
                                                              ...
                                                              <tr>
                                                                <td class="table-td">{{ $costumer->id}}</td>
                                                                <td class="table-td">{{ $costumer->name }}</td>
                                                                <td class="">
                                                                    <span class="flex">
                                                                ...
                                                                <td class="">
                                                                    <div
                                                                        ...
                                                                        <a href="{{ route('superadmin.costumer.edit', $costumer->id) }}">
                                                                            <button class="action-btn" type="button">
                                                                                <iconify-icon
                                                                                    icon="heroicons:pencil-square"></iconify-icon>
                                                                            </button>
                                                                        </a>
                                                                        <button class="action-btn" type="button" data-bs-toggle="modal" data-bs-target="#small_modal_{{$costumer->id}}">
                                                                            <iconify-icon
                                                            ...
                                                            <div class="modal fade fixed top-0 left-0 hidden w-full h-full outline-none overflow-x-hidden overflow-y-auto" id="small_modal_{{$costumer->id}}" tabindex="-1" aria-labelledby="small_modal" aria-hidden="true">
                                                                <div class="modal-dialog modal-sm relative w-auto pointer-events-none">
                                                                  <div class="modal-content border-none shadow-lg relative flex flex-col w-full pointer-events-auto bg-white bg-clip-padding
                                                                  rounded-md outline-none text-current">
                                                                    <div class="relative bg-white rounded-lg shadow dark:bg-slate-700">
                                                                    <form action="{{ route('superadmin.costumer.remove') }}" method="POST">
                                                                        @csrf
                                                                      <!-- Modal header -->
                                                                      ...
                                                                      <div class="p-6 space-y-4">
                                                                          <input type="hidden" name="company_id" value="{{$costumer->id}}">
                                                                        <h6 class="text-base text-slate-900 dark:text-white leading-6">
                                                                          Are you sure that you want to remove the company {{ $costumer->name}}?
                                                                        </h6>
