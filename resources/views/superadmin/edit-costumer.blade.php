                    ...
                    <div class="space-y-6">
                      ...
                      <div class="card">
                        ...
                        <div class="card-body p-6">
                          ...
                          <form class=" mt-10" action="{{ route('superadmin.costumer.update') }}" method="POST">
                            @csrf
                            ...
                            <div class=" active" data-step="1">
                              <div class="grid lg:grid-cols-2 md:grid-cols-2 grid-cols-1 gap-5">
                                ...
                                <div class="input-area">
                                  ...
                                  <input id="company_name" name="company_name" type="text" class="form-control" value="{{ $costumer->name }}"  required placeholder="Company name">
                                </div>
                                <div class="input-area">
                                  <label for="company_domain" class="form-label">Company Domain*</label>
                                  <input id="company_domain" name="company_domain" type="text" class="form-control" value="{{ $costumer->domain }}"  required  placeholder="Company domain">
                                </div>
                                <div class="input-area">
                                  <label for="company_email" class="form-label">Email*</label>
                                  <input id="company_email" name="company_email" type="text" class="form-control" value="{{ $costumer->email }}"  required  placeholder="Enter the company Email">
                                </div>
                                <div class="input-area">
                                  ...
                                  <select name="typology" id="typology" class="form-control w-full mt-2" required>
                                    ...
                                    <option value="{{ $typology->id}}" {{ (($costumer->typology == $typology->id)?'selected':'') }} class="py-1 inline-block font-Inter font-normal text-sm text-slate-600">
                                      {{ $typology->name }}
                                    </option>
                                    @endforeach
                                  </select>
                              ...
                              <div class="grid lg:grid-cols-2 md:grid-cols-2 grid-cols-2 gap-5 my-6">
                                
                                @foreach ($templateName as $templateId => $row)
                                <div class="checkbox-area">
                                  <label class="inline-flex items-center cursor-pointer">
                                    <input type="checkbox" class="hidden" value="{{ $templateId }}" {{ ((in_array($templateId, $user_templates))?'checked':'') }} name="templates[]">
