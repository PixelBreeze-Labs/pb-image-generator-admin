    ...
    <div class="flex flex-col justify-between min-h-screen">
      ...
      overflow-hidden">
            ...
            dark:text-white font-normal">
                      ...
                      <li>
                        <form id="logout-form" action="{{ route('logout') }}" method="POST" class="row">
                            @csrf
                        </form>
                        <a href="signin-one.html" onclick="document.getElementById('logout-form').submit()" class="block px-4 py-2 hover:bg-slate-100 dark:hover:bg-slate-600 dark:hover:text-white font-inter text-sm text-slate-600
            dark:text-white font-normal">
