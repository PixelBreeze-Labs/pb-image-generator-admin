<div class="card-text h-full space-y-4 text-center">
    <div class="flex items-center space-x-7 flex-wrap justify-center">
        <div class="basicRadio">
            <label class="flex items-center cursor-pointer">
                <input type="radio" class="hidden" name="custom_template_type" value="web_news_story" onchange="window.location.href ='/admin/template-form/21'" checked>
        ...
        <div class="basicRadio">
            <label class="flex items-center cursor-pointer">
                <input type="radio" class="hidden" name="custom_template_type" value="story_2" onchange="window.location.href ='/admin/template-form/23'">
                <span class="flex-none bg-white dark:bg-slate-500 rounded-full border inline-flex ltr:mr-2 rtl:ml-2 relative transition-all duration-150 h-[16px] w-[16px] border-slate-400 dark:border-slate-600 dark:ring-slate-700"></span>
    ...
    @if(!in_array($templateData['template_type'], [ "quotes_writings_art","quotes_writings_morning","quotes_writings_thonjeza","quotes_writings_citim"]))
        <div class="input-area">
            ...
            <input id="artical_url" name="artical_url" type="text" class="form-control" placeholder="Article URL">
        </div>
        <div class="input-area">
    ...
    <div class="input-area">
        ...
        <input id="name" name="category" type="text" class="form-control" placeholder="Category">
    </div>
