<div class="card-text h-full space-y-4 text-center">
    ...
    <div class="input-area">
        ...
        <textarea id="title" name="title" rows="5" class="form-control" placeholder="Title"></textarea>
    </div>
    <div class="input-area">
        <label for="description" class="form-label">Description</label>
        <textarea id="description" name="sub_text" rows="5" class="form-control" placeholder="Description"></textarea>
    </div>
    <div class="input-area">
